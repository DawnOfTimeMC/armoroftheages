...
public class ChestExaltedAurumArmorModel<T extends LivingEntity> extends ArmorModel<T> {
    ...
    public static LayerDefinition createLayerDefinition() {
        ...
        PartDefinition right_arm = root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(67, 10).addBox(-4.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.3F))
                .texOffs(52, 20).addBox(-4.5F, 6.75F, -2.5F, 5.0F, 1.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(-4.0F, 2.0F, 0.0F));
        right_arm.addOrReplaceChild("RightArm_r1", CubeListBuilder.create().texOffs(0, 7).mirror().addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(0.5F, 0.75F, -3.0F, -0.2775F, 0.8742F, -0.6854F));
        right_arm.addOrReplaceChild("RightArm_r2", CubeListBuilder.create().texOffs(0, 7).mirror().addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(0.5F, 2.75F, -2.5F, 0.845F, 0.3772F, 0.9251F));
        right_arm.addOrReplaceChild("RightArm_r3", CubeListBuilder.create().texOffs(0, 7).mirror().addBox(-1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(1.0F, 1.75F, -3.375F, 0.3109F, 0.8656F, 0.0694F));
        right_arm.addOrReplaceChild("RightArm_r4", CubeListBuilder.create().texOffs(20, 27).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 1.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(-1.075F, 1.5F, -2.525F, -0.2386F, 0.2316F, -0.8142F));
        right_arm.addOrReplaceChild("RightArm_r5", CubeListBuilder.create().texOffs(76, 25).mirror().addBox(-3.0F, -0.5F, -2.55F, 4.0F, 5.0F, 5.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(-4.2365F, 0.7613F, 0.0F, 3.1416F, 0.0F, -2.9671F));
        right_arm.addOrReplaceChild("RightArm_r6", CubeListBuilder.create().texOffs(64, 0).mirror().addBox(-0.875F, -2.1249F, -2.8312F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.4F)).mirror(false), PartPose.offsetAndRotation(-2.15F, -0.9501F, -0.2562F, 3.1416F, 0.0F, 2.9671F));
        right_arm.addOrReplaceChild("RightArm_r7", CubeListBuilder.create().texOffs(102, 0).mirror().addBox(-0.875F, -2.1249F, -2.5812F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.2F)).mirror(false)
                .texOffs(90, 0).mirror().addBox(4.125F, -2.1249F, -2.5812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offsetAndRotation(-2.125F, -0.8751F, -0.0063F, 3.1416F, 0.0F, 2.9671F));
        right_arm.addOrReplaceChild("RightArm_r8", CubeListBuilder.create().texOffs(70, 35).mirror().addBox(-0.202F, -2.4957F, -2.9937F, 5.0F, 5.0F, 6.0F, CubeDeformation.NONE).mirror(false), PartPose.offsetAndRotation(-4.375F, -1.1251F, -0.0063F, -0.0123F, -0.0065F, -0.5669F));

        PartDefinition left_arm = root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(67, 10).mirror().addBox(0.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.3F)).mirror(false)
                .texOffs(52, 20).mirror().addBox(-0.5F, 6.75F, -2.5F, 5.0F, 1.0F, 5.0F, CubeDeformation.NONE).mirror(false)
                .texOffs(67, 10).mirror().addBox(0.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.3F)).mirror(false), PartPose.offset(4.0F, 2.0F, 0.0F));
        left_arm.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(90, 0).addBox(-5.125F, -2.1249F, -2.5812F, 1.0F, 5.0F, 5.0F, new CubeDeformation(0.2F))
                .texOffs(102, 0).addBox(-7.125F, -2.1249F, -2.5812F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(2.125F, -0.8751F, -0.0063F, 3.1416F, 0.0F, -2.9671F));
        left_arm.addOrReplaceChild("LeftArm_r2", CubeListBuilder.create().texOffs(64, 0).addBox(-7.125F, -2.1249F, -2.8312F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.4F)), PartPose.offsetAndRotation(2.15F, -0.9501F, -0.2562F, 3.1416F, 0.0F, -2.9671F));
        left_arm.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(70, 35).addBox(-4.798F, -2.4957F, -2.9937F, 5.0F, 5.0F, 6.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(4.375F, -1.1251F, -0.0063F, -0.0123F, 0.0065F, 0.5669F));
        left_arm.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-0.5F, 0.75F, -3.0F, -0.2775F, -0.8742F, 0.6854F));
        left_arm.addOrReplaceChild("LeftArm_r5", CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-0.5F, 2.75F, -2.5F, 0.845F, -0.3772F, -0.9251F));
        left_arm.addOrReplaceChild("LeftArm_r6", CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 0.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-1.0F, 1.75F, -3.375F, 0.3109F, -0.8656F, -0.0694F));
        left_arm.addOrReplaceChild("LeftArm_r7", CubeListBuilder.create().texOffs(83, 10).addBox(-2.0F, -3.5F, -2.55F, 5.0F, 8.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(3.9865F, 3.7613F, 0.0F, 0.0F, 3.1416F, 0.0F));
