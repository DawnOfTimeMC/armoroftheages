package org.dotarmorweapons.util;
...
import org.dotarmorweapons.block.templates.WaterloggedBlock;
...
public class DoTBUtils {
	...
	public static final ITextComponent			TOOLTIP_HOLD_SHIFT		= new TranslationTextComponent("tooltip." + dotarmorweapons.MOD_ID + ".hold_key").withStyle(TextFormatting.GRAY).append(new TranslationTextComponent("tooltip." + dotarmorweapons.MOD_ID + ".shift").withStyle(TextFormatting.AQUA));
	...
	//Item tags
	public static final Tags.IOptionalNamedTag<Item>	LIGHTERS				= ItemTags.createOptional(new ResourceLocation(dotarmorweapons.MOD_ID, "lighters"));

	//Block tags
	public static final Tags.IOptionalNamedTag<Block>	COVERED_BLOCKS			= BlockTags.createOptional(new ResourceLocation(dotarmorweapons.MOD_ID, "covered_blocks"));
	...
	public static List<ItemStack> getLootList(final ServerWorld serverWorld, final BlockState stateIn, final ItemStack itemStackHand, final String name) {
		final LootTable				table		= serverWorld.getServer().getLootTables().get(new ResourceLocation(dotarmorweapons.MOD_ID + ":blocks/" + name));
	...
	public static void addTooltip(final List<ITextComponent> tooltip, final String... tooltipNames) {
		if (Screen.hasShiftDown()) {
			for (final String tooltipName : tooltipNames) {
				tooltip.add(new TranslationTextComponent("tooltip." + dotarmorweapons.MOD_ID + "." + tooltipName).withStyle(TextFormatting.GRAY));
			}
		} else {
