package org.dotarmorweapons.registry;
...
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.HOLY;
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.IRON_PLATE;
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.JAPANESE_LIGHT;
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.O_YOROI;
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.PHARAOH;
import static org.dotarmorweapons.util.DoTBMaterials.ArmorMaterial.RAIJIN;

import java.util.ArrayList;
import java.util.List;
import java.util.function.Supplier;

import org.dotarmorweapons.dotarmorweapons;
import org.dotarmorweapons.DoTBConfig;
import org.dotarmorweapons.block.templates.FlowerPotBlockDoTB;
import org.dotarmorweapons.client.model.armor.*;
import org.dotarmorweapons.item.IHasFlowerPot;
import org.dotarmorweapons.item.IconItem;
import org.dotarmorweapons.item.templates.CustomArmorItem;
import org.dotarmorweapons.item.templates.HatItem;
import org.dotarmorweapons.item.templates.ItemDoTB;
import org.dotarmorweapons.item.templates.PotItem;
import org.dotarmorweapons.util.DoTBFoods;
		...
		if (item instanceof IHasFlowerPot) {
			...
			if (itemForPot.hasFlowerPot()) {
				...
				DoTBItemsRegistry.finalReg(potName,
						new BlockItem(potBlock, new Item.Properties().tab(dotarmorweapons.DOTB_TAB)));
